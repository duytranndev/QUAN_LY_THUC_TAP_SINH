(function (global, factory) {
            ...
            if (svg) {
                ...
                if (_hasOffsetBug) {
                    ...
                    while (b && (b = b.parentNode) && b !== m && b.parentNode) {
                        if (
                            (_win.getComputedStyle(b)[_transformProp] + '')
                                .length > 4
                        ) {
                            x = b.offsetLeft;
                            y = b.offsetTop;
    ...
    var gsap,
        ...
        _onMultiTouchDocumentEnd = function _onMultiTouchDocumentEnd(event) {
            _isMultiTouching =
                event.touches && _dragCount < event.touches.length;
        ...
        _setSelectable = function _setSelectable(elements, selectable) {
            ...
            while (i--) {
                e = elements[i];
                e.ondragstart = e.onselectstart = selectable
                    ? null
                    : _emptyFunc;
                gsap.set(e, {
                    lazy: true,
        ...
        _initCore = function _initCore(required) {
            if (_windowExists() && document.body) {
                ...
                _isAndroid =
                    nav &&
                    nav.userAgent.toLowerCase().indexOf('android') !== -1;
                _isTouchDevice =
                    ('ontouchstart' in _docElement$1 &&
                        'orientation' in _win$1) ||
                    (nav &&
                        (nav.MaxTouchPoints > 0 || nav.msMaxTouchPoints > 0));
        ...
        function Draggable(target, vars) {
            ...
            var type = (vars.type || 'x,y').toLowerCase(),
                ...
                render = function render(suppressEvents) {
                        ...
                        while (e && !isRoot) {
                            ...
                            if (allowX) {
                                ...
                                if (gap < 0) {
                                    ...
                                    pointerX >
                                        rect.right - autoScrollMarginRight &&
                                    gap
                                ) {
                                    checkAutoScrollBounds = true;
                                    changeX = Math.min(
                                    ...
                                    pointerX <
                                        rect.left + autoScrollMarginLeft &&
                                    parent.scrollLeft
                                ) {
                                    checkAutoScrollBounds = true;
                                    changeX = -Math.min(
                    ...
                    if (dirty) {
                        ...
                        if (
                            ...
                            if (
                                _dispatchEvent(self, 'drag', 'onDrag') === false
                            ) {
                                if (allowX) {
                                    self.x -= self.deltaX;
                                }
                ...
                buildPointSnapFunc = function buildPointSnapFunc(
                    ...
                    radius =
                        radius && radius < _bigNum ? radius * radius : _bigNum;
                ...
                recordStartPositions = function recordStartPositions() {
                    ...
                    if (scrollProxy) {
                        ...
                        if (rotationMode) {
                            ...
                            startElementY = self.y =
                                Math.atan2(y, x) * _RAD2DEG;
                        } else {
                    ...
                    if (hasBounds && edgeTolerance) {
                        ...
                        if (!rotationMode) {
                            if (startElementY > maxY) {
                                startElementY =
                                    maxY +
                                    (startElementY - maxY) / edgeTolerance;
                            } else if (startElementY < minY) {
                                startElementY =
                                    minY -
                                    (minY - startElementY) / edgeTolerance;
                            }
                        }
                    }
                ...
                onClick = function onClick(e) {
                    var time = _getTime(),
                        ...
                        defaultPrevented =
                            self.pointerEvent &&
                            self.pointerEvent.defaultPrevented,
