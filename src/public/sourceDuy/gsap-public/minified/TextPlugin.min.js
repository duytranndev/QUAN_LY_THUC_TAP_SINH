...
!(function (D, u) {
    ...
    function emojiSafeSplit(D, u, F) {
        ...
        for (var C, E, e = [], t = D.length, n = 0; n < t; n++)
            ((55296 <= (E = D.charAt(n)).charCodeAt(0) &&
                E.charCodeAt(0) <= 56319) ||
                (65024 <= D.charCodeAt(n + 1) &&
                    D.charCodeAt(n + 1) <= 65039)) &&
                ...
                if (
                    ...
                    for (
                        s.delimiter = u.delimiter || '',
                            ...
                            (l = l || document.createElement('div')).innerHTML =
                                u.value,
