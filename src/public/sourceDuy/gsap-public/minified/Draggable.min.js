...
!(function (e, t) {
    ...
    function v(e, t) {
        if (e.parentNode && (p || w(e))) {
            var n = S(e),
                ...
                s = p.createElementNS
                    ? p.createElementNS(o.replace(/^https/, 'http'), r)
                    : p.createElement(r);
            return (
                t &&
                    (n
    ...
    var p,
        ...
        x = 'transform',
        m = x + 'Origin',
        w = function _setDoc(e) {
            var t = e.ownerDocument || e;
            !(x in e.style) &&
                'msTransform' in e.style &&
                (m = (x = 'msTransform') + 'Origin');
            for (; t.parentNode && (t = t.parentNode); );
            if (((d = window), (f = new fe()), t)) {
                (r = (p = t).documentElement), (i = t.body);
                var n = t.createElement('div'),
                    o = t.createElement('div');
                i.appendChild(n),
                    n.appendChild(o),
                    (n.style.position = 'static'),
                    (n.style[x] = 'translate3d(0,0,1px)'),
                    (g = o.offsetParent !== n),
                    i.removeChild(n);
            }
            return t;
        },
        b = function _forceNonZeroScale(e) {
            for (var t, n; e && e !== i; )
                (n = e._gsap) &&
                    !n.scaleX &&
                    !n.scaleY &&
        ...
        D = [],
        L = [],
        M = function _getDocScrollTop() {
            return (
                d.pageYOffset || p.scrollTop || r.scrollTop || i.scrollTop || 0
            );
        },
        ...
        k = function _placeSiblings(e, t) {
            ...
            if (e === d) return e;
            if (
                (c.length || c.push(v(e, 1), v(e, 2), v(e, 3)),
                (n = l ? h : u),
                l)
            )
                (r = s ? { x: 0, y: 0 } : e.getBBox()),
                    (a = (o = e.transform ? e.transform.baseVal : {})
                        .numberOfItems
                        ? ((i =
                              (o =
                                  1 < o.numberOfItems
                ...
                if (((i = a = 0), g))
                    for (
                        ...
                        4 < (d.getComputedStyle(r)[x] + '').length &&
                            ((i = r.offsetLeft), (a = r.offsetTop), (r = 0));
                ((r = n.style).top = e.offsetTop - a + 'px'),
                    (r.left = e.offsetLeft - i + 'px'),
                    (o = d.getComputedStyle(e)),
                    (r[x] = o[x]),
                    (r[m] = o[m]),
                    (r.border = o.border),
                    (r.borderLeftStyle = o.borderLeftStyle),
                    (r.borderTopStyle = o.borderTopStyle),
                    (r.borderLeftWidth = o.borderLeftWidth),
                    (r.borderTopWidth = o.borderTopWidth),
                    (r.position =
                        'fixed' === o.position ? 'fixed' : 'absolute'),
    ...
    function getGlobalMatrix(e, t, n) {
        if (!e || !e.parentNode || (p || w(e)).documentElement === e)
            return new fe();
        var o = b(e.parentNode),
            r = S(e) ? D : L,
            i = k(e, n),
    ...
    function ra() {
        return !Ne.length && ge.ticker.remove(pa);
    }
    function sa(e) {
    ...
    function ya(e) {
        (Le = e.touches && De < e.touches.length), va(e.target, 'touchend', ya);
    }
    function za(e) {
        (Le = e.touches && De < e.touches.length), ua(e.target, 'touchend', ya);
    }
    function Aa(e) {
        return (
            xe.pageYOffset ||
    ...
    function Ca(e, t) {
        ua(e, 'scroll', t), We(e.parentNode) || Ca(e.parentNode, t);
    }
    function Da(e, t) {
        va(e, 'scroll', t), We(e.parentNode) || Da(e.parentNode, t);
    }
    function Fa(e, t) {
        ...
        return Math.max(
            0,
            We(e)
                ? Math.max(ve[o], l[o]) - (xe['inner' + n] || ve[r] || l[r])
                : e[o] - e[r],
        );
    }
    function Ga(e, t) {
        ...
        var t = e.ownerDocument || me,
            n = X(e.pageX)
                ...
                : {
                      left: e.pageX - Ba(t),
                      top: e.pageY - Aa(t),
                      right: e.pageX - Ba(t) + 1,
                      bottom: e.pageY - Aa(t) + 1,
                  };
        return (
            X(n.right) && !X(n.width)
        ...
        R && !1 !== r.force3D
            ...
            (this.left = function (e, t) {
                ...
                (e = -e) < 0
                    ...
                    : (f = 0),
                    (f || o) &&
                        (this._skip || (p[O] = c + -f + 'px,' + -h + d),
                        0 <= f + y && (p.paddingRight = f + y + 'px')),
                    (i.scrollLeft = 0 | e),
                    (x = i.scrollLeft);
            }),
            ...
            (this.calibrate = function (e) {
                ...
                (g = i.scrollTop),
                    ...
                    (r &&
                        ...
                        (p.width = '100%'),
                        (p.paddingRight = y + 'px'),
                        B && (p.paddingBottom = t.paddingBottom),
                        (a = i.clientWidth),
                        (l = i.clientHeight),
                        (m = i.scrollWidth),
                        (v = i.scrollHeight),
    ...
    function Wa(e) {
        if (T() && document.body) {
            ...
            (xe = window),
                ...
                (Xe = 'grab' === ye.style.cursor ? 'grab' : 'move'),
                (Me = t && -1 !== t.userAgent.toLowerCase().indexOf('android')),
                (be =
                    ('ontouchstart' in ve && 'orientation' in xe) ||
    ...
    var ge,
        ...
        A = {},
        Fe = {},
        I = function _getElementBounds(e, t) {
            t = we(t)[0];
            var n,
                o,
                r,
    ...
    function Draggable(h, u) {
        ...
        function hh(e) {
            if (Z.autoScroll && Z.isDragging && (ee || k)) {
                var t,
                    n,
                    o,
                    r,
                    ...
                    ee = !1,
                        ...
                        Ie.scrollLeft =
                            null != xe.pageXOffset
                                ...
                                : ce.body.scrollLeft,
                        r = Z.pointerX - Ie.scrollLeft,
                        i = Z.pointerY - Ie.scrollTop;
                    c && !n;

                )
                    (t = (n = We(c.parentNode)) ? Ie : c.parentNode),
                        (o = n
                            ? {
                                  bottom: Math.max(
                                      ve.clientHeight,
            ...
            if (k) {
                var u = Z.x,
                    p = Z.y;
                K
                    ? ((Z.deltaX = u - parseFloat(le.rotation)),
                      (Z.rotation = u),
                      (le.rotation = u + 'deg'),
                      le.renderTransform(1, le))
                    : f
                    ? (U && ((Z.deltaY = p - f.top()), f.top(p)),
                      q && ((Z.deltaX = u - f.left()), f.left(u)))
                    : G
                    ? (U &&
                          ((Z.deltaY = p - parseFloat(le.y)),
                          (le.y = p + 'px')),
                      q &&
                          ((Z.deltaX = u - parseFloat(le.x)),
                          (le.x = u + 'px')),
                      le.renderTransform(1, le))
                    : (U &&
                          ((Z.deltaY = p - parseFloat(h.style.top || 0)),
                          (h.style.top = p + 'px')),
                      q &&
                          ((Z.deltaY = u - parseFloat(h.style.left || 0)),
                          (h.style.left = u + 'px'))),
                    !g ||
                        e ||
                        F ||
                        (!(F = !0) === La(Z, 'drag', 'onDrag') &&
                            (q && (Z.x -= Z.deltaX),
                            U && (Z.y -= Z.deltaY),
                            hh(!0)),
                        (F = !1));
        ...
        function ih(e, t) {
            ...
            h._gsap || (le = ge.core.getCache(h)),
                G
                    ? ((Z.x = parseFloat(le.x)), (Z.y = parseFloat(le.y)))
                    : K
                    ? (Z.x = Z.rotation = parseFloat(le.rotation))
                    : f
                    ? ((Z.y = f.top()), (Z.x = f.left()))
                    : ((Z.y =
                          parseInt(h.style.top || ((o = Ia(h)) && o.top), 10) ||
                          0),
                      (Z.x =
                          parseInt(h.style.left || (o || {}).left, 10) || 0)),
                (C || N || R) &&
                    !t &&
                    ...
                    (R &&
                        ((Ae.x = Z.x),
                        (Ae.y = Z.y),
                        (n = R(Ae)).x !== Z.x && ((Z.x = n.x), (k = !0)),
                        n.y !== Z.y && ((Z.y = n.y), (k = !0))),
                    C &&
                        (n = C(Z.x)) !== Z.x &&
                        ((Z.x = n), K && (Z.rotation = n), (k = !0)),
                    N && ((n = N(Z.y)) !== Z.y && (Z.y = n), (k = !0))),
                k && hh(!0),
                e ||
                    ((Z.deltaX = Z.x - r),
                    (Z.deltaY = Z.y - i),
                    La(Z, 'throwupdate', 'onThrowUpdate'));
        }
        function jh(a, l, s, n) {
            return (
                null == l && (l = -ke),
        ...
        function lh() {
            ...
            (L = !1),
                f
                    ? (f.calibrate(),
                      (Z.minX = E = -f.maxScrollLeft()),
                      (Z.minY = Y = -f.maxScrollTop()),
                      (Z.maxX = M = Z.maxY = S = 0),
                      (L = !0))
                    : u.bounds &&
                      ((e = Ma(u.bounds, h.parentNode)),
                      K
                          ? ((Z.minX = E = e.left),
                            (Z.maxX = M = e.left + e.width),
                            (Z.minY = Y = Z.maxY = S = 0))
                          : X(u.bounds.maxX) && X(u.bounds.maxY)
                          ? ((t = Ma(h, h.parentNode)),
                            (Z.minX = E = Math.round(
                                Bg(d, 'px') + e.left - t.left - 0.5,
                            )),
                            (Z.minY = Y = Math.round(
                                Bg(j, 'px') + e.top - t.top - 0.5,
                            )),
                            (Z.maxX = M = Math.round(E + (e.width - t.width))),
                            (Z.maxY = S = Math.round(
                                Y + (e.height - t.height),
                            )))
                          : ((e = u.bounds),
                            ...
                            (Z.maxX = M = e.maxX),
                            (Z.maxY = S = e.maxY)),
                      M < E && ((Z.minX = M), (Z.maxX = M = E), (E = Z.minX)),
                      S < Y && ((Z.minY = S), (Z.maxY = S = Y), (Y = Z.minY)),
                      K && ((Z.minRotation = E), (Z.maxRotation = M)),
                      (L = !0)),
                u.liveSnap &&
                    ((n = !0 === u.liveSnap ? u.snap || {} : u.liveSnap),
                    (o = _e(n) || V(n)),
                    K
                        ? ((C = jh(o ? n : n.rotation, E, M, 1)), (N = null))
                        : n.points
                        ? (R = (function buildPointSnapFunc(
                              s,
                              l,
                              c,
                              d,
        ...
        function oh(e, t) {
            ...
            e && Ee
                ? (!0 === e &&
                      ...
                      K
                          ? (e.rotation = Pa(Z, o ? n : n.rotation, M, E, 1, t))
                          : (q &&
                                (e[d] = Pa(
                                    Z,
                  ...
                  (Z.tween = r = ge.to(f || h, {
                      ...
                      onComplete: mh,
                      onInterrupt: nh,
                      onUpdate: u.fastMode ? La : ih,
                      onUpdateParams: u.fastMode
                          ? [Z, 'onthrowupdate', 'onThrowUpdate']
                          : n && n.radius
                          ? [!1, !0]
                          : [],
                  })),
        ...
        function qh() {
            ...
            ph(!1),
                B &&
                    ...
                    (w = Fe.x),
                    (b = Fe.y)),
                k && (pe(Z.pointerX, Z.pointerY), hh(!0)),
                f
                    ? (lh(), (D = f.top()), (T = f.left()))
                    : (de() ? (ih(!0, !0), lh()) : Z.applyBounds(),
                      K
                          ? ((e = h.ownerSVGElement
                                ? [
                                      le.xOrigin - h.getBBox().x,
                                      le.yOrigin - h.getBBox().y,
                                  ]
                                : (Ia(h)[Ye] || '0 0').split(' ')),
                            (P = Z.rotationOrigin = getGlobalMatrix(h).apply({
                                x: parseFloat(e[0]) || 0,
                                y: parseFloat(e[1]) || 0,
                            })),
                            ih(!0, !0),
                ...
                if (
                    ...
                    Te[e.type]
                        ? ((y = ~e.type.indexOf('touch')
                          ...
                          ua(y, 'touchcancel', he),
                          ua(ce, 'touchstart', za))
                        : ((y = null), ua(ce, 'mousemove', ue)),
                    (I = null),
                    (Se && y) ||
                        (ua(ce, 'mouseup', he),
                        e && e.target && ua(e.target, 'mouseup', he)),
                    (v = ie.call(Z, e.target) && !1 === u.dragClickables && !t))
                )
                    return (
                        ua(e.target, 'change', he),
                ...
                if (
                    ((A =
                        !(
                            !y ||
                            q == U ||
                            !1 === Z.vars.allowNativeTouchScrolling ||
                            (Z.vars.allowContextMenu &&
                                e &&
                                (e.ctrlKey || 2 < e.which))
                        ) && (q ? 'y' : 'x')),
                    (z = !A && !Z.allowEventDefault) &&
                        (wa(e), ua(xe, 'touchforcechange', wa)),
                    e.changedTouches
                    ...
                    (function _addToRenderQueue(e) {
                        Ne.push(e), 1 === Ne.length && ge.ticker.add(pa);
                    })(hh),
                    (b = Z.pointerY = e.pageY),
                    (w = Z.pointerX = e.pageX),
                    La(Z, 'pressInit', 'onPressInit'),
                    (A || Z.autoScroll) && Ga(h.parentNode),
                    !h.parentNode ||
                        !Z.autoScroll ||
                        f ||
                        K ||
                    ...
                    (!u.zIndexBoost && (K || f || !1 === u.zIndexBoost)) ||
                        (h.style.zIndex = Draggable.zIndex++),
                    (Z.isPressed = !0),
                    (g = !(!u.onDrag && !Z._listeners.drag)),
                    (s = !(!u.onMove && !Z._listeners.move)),
                    !K && (!1 !== u.cursor || u.activeCursor))
                )
                    for (n = $.length; -1 < --n; )
                        ge.set($[n], {
                            cursor:
        ...
        function yh(e) {
            var t = Ce(),
                ...
                o = t - J < 40,
                r = n && H === ae,
                i = Z.pointerEvent && Z.pointerEvent.defaultPrevented,
                a = n && c === ae,
                l = e.isTrusted || (null == e.isTrusted && n && r);
            if (
                ((r || (o && !1 !== Z.vars.suppressClickOnDrag)) &&
                    e.stopImmediatePropagation &&
                    e.stopImmediatePropagation(),
                n &&
                    (!Z.pointerEvent || !Z.pointerEvent.defaultPrevented) &&
                    (!r || (l && !a)))
            )
                return l && r && (c = ae), void (H = ae);
            (Z.isPressed || o || n) && ((l && e.detail && n && !i) || wa(e));
        }
        function zh(e) {
            return B
                ? {
        ...
        var p,
            ...
            j = G ? 'y' : 'top',
            q = !(!~n.indexOf('x') && !~n.indexOf('left') && 'scroll' !== n),
            U = !(!~n.indexOf('y') && !~n.indexOf('top') && 'scroll' !== n),
            Q = u.minimumMovement || 2,
            ...
            ue = function onMove(e) {
                ...
                if (p && !Le && Z.isPressed && e) {
                    ...
                    (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) &&
                        ...
                        (Me && A === I)) &&
                        ((I = a < i && q ? 'x' : 'y'),
                        A && I !== A && ua(xe, 'touchforcechange', wa),
                        !1 !== Z.vars.lockAxisOnTouchScroll &&
                            q &&
                            U &&
                            ((Z.lockedAxis = 'x' === I ? 'y' : 'x'),
                            V(Z.vars.onLockAxis) &&
                                Z.vars.onLockAxis.call(Z, l)),
                        Me && A === I))
                        ? he(l)
                        : ((z =
                              Z.allowEventDefault ||
            ...
            pe = function setPointerPosition(e, t, n) {
                ...
                (Z.pointerX = e),
                    ...
                    se && ((e -= Ba(ce)), (t -= Aa(ce))),
                    K
                        ? ((a = Math.atan2(P.y - t, e - P.x) * Pe),
                          180 < (l = Z.y - a)
                              ? ((D -= 360), (Z.y = a))
                              : l < -180 && ((D += 360), (Z.y = a)),
                          (i =
                              Z.x !== T || Math.abs(D - a) > Q
                                  ? ((Z.y = a), T + (D - a) * c)
                                  : T))
                        : (B &&
                              ((s = e * B.a + t * B.c + B.e),
                    ...
                    (C || N || R) && (Z.x !== i || (Z.y !== a && !K))
                        ...
                        : L &&
                          (M < i
                              ...
                              : i < E && (i = E + Math.round((i - E) * d)),
                          K ||
                              (S < a
                                  ? (a = Math.round(S + (a - S) * d))
                                  : a < Y &&
                                    (a = Math.round(Y + (a - Y) * d)))),
                    (Z.x === i && (Z.y === a || K)) ||
                        (K
                            ? ((Z.endRotation = Z.x = Z.endX = i), (k = !0))
                            : (U && ((Z.y = Z.endY = a), (k = !0)),
                              q && ((Z.x = Z.endX = i), (k = !0))),
                        n && !1 === La(Z, 'move', 'onMove')
                            ? ((Z.pointerX = u),
                              (Z.pointerY = p),
                              (D = h),
                              (Z.x = f),
                ...
                if (
                    ...
                    var n,
                        ...
                        c =
                            ...
                            e &&
                            (e.ctrlKey || 2 < e.which),
                        d = ge.delayedCall(0.001, sh);
                    if (
                        (y
                            ? (va(y, 'touchend', onRelease),
                              va(y, 'touchmove', ue),
                              va(y, 'touchcancel', onRelease),
                              va(ce, 'touchstart', za))
                            : va(ce, 'mousemove', ue),
                        va(xe, 'touchforcechange', wa),
                        (Se && y) ||
                            (va(ce, 'mouseup', onRelease),
                            e &&
                                e.target &&
                                va(e.target, 'mouseup', onRelease)),
                        (k = !1),
                        v && !c)
                    )
                        return (
                            e &&
                                (va(e.target, 'change', onRelease),
                                (Z.pointerEvent = l)),
                            Ra($, !1),
                    ...
                    if ((sa(hh), !K))
                        for (o = $.length; -1 < --o; )
                            Ha(
                                $[o],
                                'cursor',
                                u.cursor || (!1 !== u.cursor ? Xe : null),
                            );
                    if (
                        (s && ((J = Oe = Ce()), (Z.isDragging = !1)), De--, e)
                    ) {
                        if (
                            (n = e.changedTouches) &&
                            (e = n[0]) !== x &&
                    ...
                    return (
                        c && l
                            ? (wa(l), (z = !0), La(Z, 'release', 'onRelease'))
                            : l && !s
                            ? ((z = !1),
                              O &&
                                  (u.snap || u.bounds) &&
                                  oh(u.inertia || u.throwProps),
                              La(Z, 'release', 'onRelease'),
                              (Me && 'touchmove' === l.type) ||
                                  -1 !== l.type.indexOf('cancel') ||
                                  (La(Z, 'click', 'onClick'),
                                  Ce() - ae < 300 &&
                                      La(Z, 'doubleclick', 'onDoubleClick'),
                                  (i = l.target || h),
                                  (ae = Ce()),
                                          ...
                                          (i.click
                                              ...
                                              : ce.createEvent &&
                                                ((r = ce.createEvent(
                                                    ...
                                                    xe,
                                                    1,
                                                    Z.pointerEvent.screenX,
                                                    Z.pointerEvent.screenY,
                                                    Z.pointerX,
                                                    Z.pointerY,
                                                    !1,
                                                    !1,
        ...
        return (
            ...
            (e.startDrag = function (e, t) {
                var n, o, r, i;
                th(e || Z.pointerEvent, !0),
                    t &&
                        !Z.hitTest(e || Z.pointerEvent) &&
                        ((n = Ka(e || Z.pointerEvent)),
                        (o = Ka(h)),
                        (r = zh({
                            x: n.left + n.width / 2,
                            y: n.top + n.height / 2,
            ...
            (e.endDrag = function (e) {
                return he(e || Z.pointerEvent, !0);
            }),
            (e.timeSinceDrag = function () {
                return Z.isDragging ? 0 : (Ce() - J) / 1e3;
            }),
                ...
                var n,
                    ...
                    s =
                        'velocity' === e && Ee
                            ...
                            : 'start';
                return (
                    'element' === s && ((a = Ka(Z.target)), (l = Ka(e))),
                    (n =
                        'start' === s
                            ? Z.x - T
                            : 'velocity' === s
            ...
            (e.applyBounds = function (e, t) {
                var n, o, r, i, a, l;
                if (e && u.bounds !== e) return (u.bounds = e), Z.update(!0, t);
                if ((ih(!0), lh(), L && !de())) {
                    if (
                        ((n = Z.x),
                        (o = Z.y),
                        ...
                        (Z.x !== n || Z.y !== o) &&
                            ((r = !0),
                            (Z.x = Z.endX = n),
                            K ? (Z.endRotation = n) : (Z.y = Z.endY = o),
                            hh((k = !0)),
                            Z.autoScroll && !Z.isDragging))
                    )
                        for (
                            Ga(h.parentNode),
                                i = h,
                            ...
                            (a = (l = We(i.parentNode)) ? Ie : i.parentNode),
                                U &&
            ...
            (e.update = function (e, t, n) {
                ...
                return (
                    ph(!t),
                    e ? Z.applyBounds() : (k && n && hh(!0), ih(!0)),
                    t && (pe(Z.pointerX, Z.pointerY), k && hh(!0)),
                    Z.isPressed &&
                        !t &&
                        ((q && 0.01 < Math.abs(o - Z.x)) ||
                            (U && 0.01 < Math.abs(r - Z.y) && !K)) &&
                        qh(),
                    Z.autoScroll &&
                        (Ga(h.parentNode, Z.isDragging),
                        (ee = Z.isDragging),
                        hh(!0),
                        Da(h, xh),
                        Ca(h, xh)),
            ...
            (e.enable = function (e) {
                var t,
                    ...
                    r = { lazy: !0 };
                if (
                    (K || !1 === u.cursor || (r.cursor = u.cursor || Xe),
                    ge.utils.checkPrefix('touchCallout') &&
                        (r.touchCallout = 'none'),
                    (r.touchAction =
                        q == U
                            ? 'none'
                    ...
                    for (n = $.length; -1 < --n; )
                        (o = $[n]),
                            ...
                            u.allowContextMenu || ua(o, 'contextmenu', gh);
                    Ra($, !1);
                }
                return (
                    Ca(h, xh),
                    ...
                    Ee &&
                        ...
                        Ee.track(
                            f || h,
                            G ? 'x,y' : K ? 'rotation' : 'top,left',
                        ),
                    (h._gsDragID = t = 'd' + Be++),
                    (Re[t] = Z),
                    f && (f.enable(), (f.element._gsDragID = t)),
                    (u.bounds || K) && qh(),
                    u.bounds && Z.applyBounds(),
                    Z
                );
            }),
            (e.disable = function (e) {
                var t,
                    n,
                    o = Z.isDragging;
                if (!K) for (t = $.length; -1 < --t; ) Ha($[t], 'cursor', null);
                if ('soft' !== e) {
                    for (t = $.length; -1 < --t; )
                        (n = $[t]),
                            Ha(n, 'touchCallout', null),
                            Ha(n, 'touchAction', null),
                            va(n, 'mousedown', th),
                            va(n, 'touchstart', th),
                            va(n, 'click', yh),
                            va(n, 'contextmenu', gh);
                ...
                return (
                    ...
                    f && f.disable(),
                    sa(hh),
                    (Z.isDragging = Z.isPressed = v = !1),
                    o && La(Z, 'dragend', 'onDragEnd'),
                    Z
                );
            }),
            (e.enabled = function (e, t) {
                return arguments.length ? (e ? Z.enable(t) : Z.disable(t)) : p;
            }),
            (e.kill = function () {
                return (
                    (Z.isThrowing = !1),
                    Z.tween && Z.tween.kill(),
                    Z.disable(),
                    ge.set($, { clearProps: 'userSelect' }),
                    delete Re[h._gsDragID],
                    Z
                );
            }),
            ~n.indexOf('scroll') &&
                ((f = e.scrollProxy = new Va(
                    h,
                ...
                (h.style.overflowY = U && !be ? 'auto' : 'hidden'),
                (h.style.overflowX = q && !be ? 'auto' : 'hidden'),
                (h = f.content)),
            K ? (o.rotation = 1) : (q && (o[d] = 1), U && (o[j] = 1)),
