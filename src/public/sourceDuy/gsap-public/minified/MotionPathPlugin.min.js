...
!(function (t, e) {
            ...
            if (
                (x(c, w, M, d.t) &&
                    ...
                    T
                        ? R
                            ? (m.t /= d.t)
                            : ((m.t = (m.t - d.t) / (1 - d.t)), P++, (b = 0))
                        : w <= P + 1 && !R && (P++, L && (b -= M))),
                m.t
                    ? x(c, P, b, m.t) && (R && i && w++, r && P++)
                    : (P--, r && w--),
                (h = []),
                (f = 1 + (u = c.length) * a),
                (g = w),
    ...
    function measureSegment(t, e, n) {
        ...
        if (R.length && N)
            for (
                t.totalLength = y = R[R.length - 1] || 0,
                    t.minLength = N,
                    x = v = 0,
                    r = 0;
                r < y;
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < P; e++)
            if (
                ...
                rf(x, y, x, (y = r + (i ? y - x : 0))), (e += 1);
            else if ('L' === o || 'Z' === o)
                'Z' === o && ((r = l), (a = h), (s.closed = !0)),
                    ('L' === o || 0.5 < Q(x - r) || 0.5 < Q(y - a)) &&
                        (rf(x, y, r, a), 'L' === o && (e += 2)),
                    (x = r),
                    (y = a);
            else if ('A' === o) {
    ...
    function pointsToSegment(t, e, n) {
        ...
        for (
            ...
            (r = x),
                ...
                (m = (h = P - r) * h + (f = w - a) * f),
                (c =
                    ((o = Math.acos((p + d - m) / $(4 * p * d))) / Math.PI) *
                    e),
                (g = $(p) * c),
                (c *= $(d)),
                (x === r && y === a) ||
        ...
        return (
            b.push(C(P), C(w), C(P), C(w)),
            T && (b.splice(0, 6), (b.length = b.length - 6)),
            b
        );
    }
    ...
    function W(t, e) {
        if (t.parentNode && (g || O(t))) {
            var n = U(t),
                ...
                l = g.createElementNS
                    ? g.createElementNS(r.replace(/^https/, 'http'), a)
                    : g.createElement(a);
            return (
                e &&
                    (n
        ...
        if ((h.length || h.push(W(t, 1), W(t, 2), W(t, 3)), (n = s ? f : u), s))
            ...
            if (((o = i = 0), P))
                for (
                    ...
                    4 < (c.getComputedStyle(a)[w] + '').length &&
    ...
    function getGlobalMatrix(t, e, n) {
        ...
        if ((h.removeChild(o), r))
            for (i = r.length; i--; )
                ((s = r[i]).scaleX = s.scaleY = 0), s.renderTransform(1, s);
    ...
    function ka(t, e, n, r, a, o, i) {
        return (
            (e =
                'cubic' === i.type
                    ? [e]
                    : (e.unshift(ia(n, r, i.unitX), a ? ia(n, a, i.unitY) : 0),
                      i.relative && ja(e),
                      [
            ...
            init: function init(t, e) {
                ...
                if (
                    ...
                    l))
                        r !== a &&
                            r !== o &&
                            i.push(ka(this, ha([], s, r, 2), t, r, 0, u, e));
                }
            },
