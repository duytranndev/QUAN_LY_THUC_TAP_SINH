    ...
    function Jt(t) {
        return t.reduce(function (t, e) {
            ...
            if (Kt[e]) t.prefix = e;
                ...
                var a =
                    'fa' === t.prefix
                        ? Xt[n] || { prefix: null, iconName: null }
                        : {};
                    ...
                    At(t).forEach(function (t) {
                        if (
                            ('childList' === t.type &&
                                ...
                                !te(t.addedNodes[0]) &&
                                ($.searchPseudoElements && o(t.target),
                                r(t.target)),
                            'attributes' === t.type &&
                                t.target.parentNode &&
    ...
    function Ce(m, p) {
        ...
        return new vt(function (a, t) {
            ...
            if (r && 'none' !== o && '' !== o) {
                ...
                if (
                    !l ||
                    (e && e.getAttribute(C) === c && e.getAttribute(O) === f)
                )
                    a();
                else {
